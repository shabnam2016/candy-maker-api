module.exports = {
  up: (queryInterface) => {
    ...
    */
    return Promise.all([
      queryInterface.bulkInsert('manufacturers', [{ "name": "August Storck KG", "country": "DE" },
      ...
      queryInterface.bulkInsert('products', [{ "name": "Mamba", "yearIntroduced": "1953-01-01", "manufacturerId": 1 },
  ...
  down: (queryInterface) => {
    ...
    */
    return promise.all([
      queryInterface.bulkDelete('manufacturers'),
